...
export function MinimalPositionCard({ pair, showUnwrapped = false, border }: PositionCardProps) {
  ...
  const symbol0 = getCurrencySymbol(currency0, chainId);
  const symbol1 = getCurrencySymbol(currency1, chainId);
      ...
      <AutoColumn gap="12px">
        <FixedHeightRow>
          <AutoRow gap="8px">
            ...
            <Text fontWeight={500} fontSize={20}>
              {!currency0 || !currency1 ? <Dots>{t('loading')}</Dots> : `${symbol0}/${symbol1}`}
            </Text>
          </AutoRow>
          <RowFixed gap="8px">
        ...
        {showMore && (
          <AutoColumn gap="8px">
            ...
            <FixedHeightRow>
              <RowFixed>
                <Text fontSize={16} fontWeight={500}>
                  {t('pool.pooledSymbol', { symbol: symbol0 })}
                </Text>
              </RowFixed>
              {token0Deposited ? (
                <RowFixed>
            ...
            <FixedHeightRow>
              <RowFixed>
                <Text fontSize={16} fontWeight={500}>
                  {t('pool.pooledSymbol', { symbol: symbol1 })}
                </Text>
              </RowFixed>
              {token1Deposited ? (
                <RowFixed>
            ...
            {stakedBalance && JSBI.greaterThan(stakedBalance.raw, BIG_INT_ZERO) && (
              <ButtonPrimary
                ...
                width="100%"
              >
                {t('pool.manageLiquidityInRewards')}
              </ButtonPrimary>
            )}
          </AutoColumn>
        )}
