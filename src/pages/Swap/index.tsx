...
export default function Swap() {
  ...
  // Trade is computed from WXCN pairs - the router handles XCN/ETHER automatically
  // via swapExactETHForTokens and swapExactTokensForETH methods
        ...
        <Wrapper id="swap-page">
          ...
          <AutoColumn gap={'md'}>
            ...
            <CurrencyInputPanel
              ...
              label={independentField === Field.INPUT && !showWrap && trade ? t('toEstimated') : t('toLabel')}
              showMaxButton={false}
            ...
            {!account ? (
              ...
              <ButtonPrimary disabled>
                <AutoRow gap="6px" justify="center">
                  {t('connecting')} <Loader stroke="white" />
                </AutoRow>
              </ButtonPrimary>
            ) : showWrap ? (
              ...
              <GreyCard style={{ textAlign: 'center' }}>
                <TYPE.main mb="4px">{t('insufficientLiquidityForTrade')}</TYPE.main>
                {singleHopOnly && <TYPE.main mb="4px">{t('tryEnablingMultiHop')}</TYPE.main>}
              </GreyCard>
            ) : showApproveFlow ? (
              <RowBetween>
                <ButtonConfirmed
