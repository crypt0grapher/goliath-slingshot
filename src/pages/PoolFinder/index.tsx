  ...
  const prerequisiteMessage = (
    <LightCard padding="45px 10px">
      <Text textAlign="center">
        {!account ? t('connectToWalletToFindPools') : t('selectTokenToFindLiquidity')}
      </Text>
    </LightCard>
  );
            ...
            hasPosition && pair ? (
              ...
              <LightCard padding="45px 10px">
                <AutoColumn gap="sm" justify="center">
                  <Text textAlign="center">{t('noLiquidityInPoolYet')}</Text>
                  <StyledInternalLink to={`/add/${currencyId(currency0, chainId)}/${currencyId(currency1, chainId)}`}>
                    <Text textAlign="center">{t('addLiquidityDot')}</Text>
                  </StyledInternalLink>
                </AutoColumn>
              </LightCard>
            )
